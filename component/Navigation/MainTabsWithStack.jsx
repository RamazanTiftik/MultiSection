...
import AIAnalysisScreen from '../../screen/DetailPages/HomeDetaiilPages/AIAnalysis/AIAnalysisScreen';
import AiChatScreen from '../../screen/DetailPages/HomeDetaiilPages/AIAnalysis/AiChatScreen';
import ThemeSetScreen from '../../screen/DetailPages/HomeDetaiilPages/ThemeSet/ThemeSetScreen';
...
function HomeStack() {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            {/* AI Analysis */}
            <Stack.Screen name="AI Analysis" component={AIAnalysisScreen} />
            ...
            {/* Set Theme */}
            <Stack.Screen name="Set Theme" component={ThemeSetScreen} />
...
// Ana Tab Yapısı
export default function MainTabs({ theme }) {
    return (
        <Tab.Navigator
            screenOptions={{
        ...
        >
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name="home" size={focused ? 30 : 24} color={focused ? theme.mainButton1 || '#007AFF' : 'gray'} />
                    ),
                }}
            />
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: () => (
                        <LinearGradient colors={[theme.mainButton1 || '#00c6ff', theme.mainButton2 || '#007AFF']} style={styles.postButton}>
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name="person" size={focused ? 30 : 24} color={focused ? theme.mainButton1 || '#007AFF' : 'gray'} />
                    ),
                }}
            />
        </Tab.Navigator>
